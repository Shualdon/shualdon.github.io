...
2. [Marcus Reorganization Energy](#Marcus Reorganization Energy)
3. [Ground-State Triplet](#Ground-State Triplet)
...
<br>
<br>
The full research paper can be found here: [DOI](https://doi-org.pitt.idm.oclc.org/10.1063/5.0059682), [ChemRxiv](https://doi.org/10.26434/chemrxiv.14176655.v1) (open access), raw data can be found on [GitHub](https://github.com/hutchisonlab/ReorganizationEnergy).
